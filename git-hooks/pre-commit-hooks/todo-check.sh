#################### Find and ask for confirmation script ####################
## Checks if a script contains the terms matched in hooks.confirm.match or  ##
## checks for TODO by default                                               ##
## See https://github.com/pimterry/git-confirm                              ##
##############################################################################
